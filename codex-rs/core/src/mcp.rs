...
use codex_mcp::SolaiAgentAppsToolsCache;
...
impl McpManager {
    ...
    pub fn new_with_extensions(
        ...
        Self {
            plugins_manager,
            extensions,
            codex_apps_tools_cache: SolaiAgentAppsToolsCache::default(),
        }
    }

    pub fn codex_apps_tools_cache(&self) -> SolaiAgentAppsToolsCache {
