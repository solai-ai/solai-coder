...
const DEFAULT_PERSONALITY_HEADER: &str = "You are SolaiAgent, a coding agent. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
pub fn model_info_from_slug(slug: &str) -> ModelInfo {
    ModelInfo {
        ...
        experimental_supported_tools: vec!["shell_command".to_string(), "apply_patch".to_string()],
