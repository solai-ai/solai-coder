...
impl TestToolServer {
    ...
    /// Tool intended for manual testing of SolaiAgent TUI rendering for MCP image tool results.
    ///
    ...
    ///
    /// Manual testing approach (SolaiAgent TUI):
    ...
    /// - Then in SolaiAgent TUI, ask it to call:
...
/// Scenarios for `image_scenario`, intended to exercise SolaiAgent TUI handling of MCP image outputs.
///
