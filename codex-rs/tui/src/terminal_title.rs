...
//! "leave the old title alone" or "clear the title SolaiAgent last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title SolaiAgent manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before SolaiAgent started managing the title.
