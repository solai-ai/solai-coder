//! Path normalization, symlink resolution, and atomic writes shared across SolaiAgent crates.
...
/// Compare paths after applying SolaiAgent's filesystem normalization.
///
